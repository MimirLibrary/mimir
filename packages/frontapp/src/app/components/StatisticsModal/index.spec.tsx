      ...
      getAllMaterials: [
        {
          ...
          id: '1',
          picture: '',
          statuses: [{ id: '7', status: StatusTypes.FREE }],
          title: 'Forrest Gump',
        },
        {
          category: 'Psychology',
          id: '2',
          picture: '',
          statuses: [{ id: '8', status: StatusTypes.FREE }],
          title: 'New Patient',
        },
        {
          category: 'Psychology',
          id: '3',
          picture: '',
          statuses: [{ id: '10', status: StatusTypes.BUSY }],
          title: 'Charity',
        },
        {
          category: 'History',
          id: '4',
          picture: '',
          statuses: [{ id: '9', status: StatusTypes.OVERDUE }],
