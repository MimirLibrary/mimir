...
export class migrationMy1656584471709 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "material" ("id" SERIAL NOT NULL, "identifier" character varying NOT NULL, "id_type" character varying NOT NULL, "type" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "picture" character varying, "title" character varying NOT NULL, "category" character varying NOT NULL, "author" character varying NOT NULL, "description" character varying NOT NULL, "location_id" integer, CONSTRAINT "PK_0343d0d577f3effc2054cbaca7f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
