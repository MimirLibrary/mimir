  ...
  return (
    <Svg
      ...
      <Path
        ...
        strokeWidth="1.5"
        d="M16 6.28a2.28 2.28 0 01-.662 1.606c-.976.984-1.923 2.01-2.936 2.958a.597.597 0 01-.822-.017l-2.918-2.94a2.281 2.281 0 012.491-3.712c.278.115.53.285.741.498L12 4.78l.106-.107A2.276 2.276 0 0116 6.28v0z"
      />
      <Path
        stroke={color}
        strokeLinecap="round"
      ...
      <Path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M6 20l-3.824-3.824A.6.6 0 012 15.752V10.5A1.5 1.5 0 013.5 9v0A1.5 1.5 0 015 10.5V15m13 1l.858-.858a.484.484 0 00-.126-.776l-.443-.221a2 2 0 00-2.308.374l-.895.895a2 2 0 00-.586 1.414V20l3.5-4z"
      />
      <Path
        stroke={color}
        strokeLinecap="round"
