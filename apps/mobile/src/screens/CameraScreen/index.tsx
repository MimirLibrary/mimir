...
export const CameraScreen = (props) => {
  ...
  return (
    ...
    <SafeAreaView style={styles.body}>
      ...
      <Canvas style={{position:'absolute', left:0, right:0, top:0, bottom:0}}>
          <Group color={Color.ACCENT_GRAY_100}>
            <DiffRect outer={outer} inner={inner} opacity={0.5}><Blur blur={4}/></DiffRect>
            {image&&<Image
              image={image}
              fit="contain"
              x={25}
